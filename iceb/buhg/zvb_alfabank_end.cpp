/*$Id: zvb_alfabank_end.c,v 5.7 2014/08/31 06:18:19 sasa Exp $*/
/*20.05.2016	15.10.2009	Белых А.И.	zvb_alfabank_end.c
Концовки файлов
*/
#include <errno.h>
#include "buhg.h"

void alfabank_h(const char *imaf,long kolz);
...
fprintf(ffr,"\
-------------------------------------------------------------------------------------------------\n");
fprintf(ffr,"%*s:%10.2f\n",iceb_tu_kolbait(62,"Разом"),"Разом",sumai);
