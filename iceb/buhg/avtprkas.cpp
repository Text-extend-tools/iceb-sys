...
/*10.03.2016	05.10.2000	Белых А.И.	avtprkas.c
...
class lock_tables kkkk("LOCK TABLES Prov WRITE,Kasord READ,Kasord1 READ,Alx READ,Blok READ,icebuser READ,Glkkv READ,Plansh READ");
