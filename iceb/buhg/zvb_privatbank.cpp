...
//  zvb_privatbank_str(++nomer_zap,fio.ravno(),kartshet.ravno(),suma,inn.ravno(),row[1],branch.ravno(),zpkod.ravno(),rlkod.ravno(),ff_dbf_tmp,ffr);
  zvb_privatbank_str(++nomer_zap,fio.ravno(),kartshet.ravno(),suma,inn.ravno(),inn.ravno(),branch.ravno(),zpkod.ravno(),rlkod.ravno(),ff_dbf_tmp,ffr);


    
 }

zvb_privatbank_end(imaf_dbf,imaf_dbf_tmp,sumai,nomer_zap,ffr,ff_dbf_tmp);
