/*$Id: b_b2_bank_on_line.c,v 5.14 2013-01-02 10:38:36 sasa Exp $*/
/*26.09.2014	04.05.2006	Белых А.И.	b2_bank_on_line.c
...
int b_b2_bank_on_line(const char *tabl)
{
...
**************/
  ...
  if(rec.kodnr.ravno()[0] != '\0')
   {
//    sprintf(doprek,"nП764О%s",rec.kodnr.ravno());
    doprek.new_plus("nП764О");
    doprek.plus(rec.kodnr.ravno());
   }     
  else
   doprek.new_plus("");
