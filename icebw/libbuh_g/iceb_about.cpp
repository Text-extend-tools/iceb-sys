...
/*31.12.2017	14.04.2010	Белых А.И.	iceb_about.c
...
gtk_about_dialog_set_copyright(GTK_ABOUT_DIALOG(about),"Copyright © 1992-2018 Aleksandr Belykh");

const gchar *avtor[]={"Aleksandr Belykh","<sasa@ukrpost.ua>","http://iceb.net.ua","tel:+380676654526",NULL};
