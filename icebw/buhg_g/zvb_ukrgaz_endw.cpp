/*$Id: zvb_ukrgaz_endw.c,v 1.4 2013/05/17 14:58:31 sasa Exp $*/
/*20.05.2016	22.10.2009	Белых А.И.	zvb_ukrgaz_endw.c
Концовки файлов
*/
#include <errno.h>
#include "buhg_g.h"
...
void ukrgaz_h(const char *imaf,long kolz,GtkWidget*);

void zvb_ukrgaz_endw(const char *imaf_dbf,const char *imaf_dbf_tmp,double sumai,int kolzap,FILE *ffr,FILE *ff_dbf_tmp,
GtkWidget *wpredok)
{
...
ukrgaz_h(imaf_dbf,kolzap,wpredok);
...
/***********************************************/
void ukrgaz_h(const char *imaf,long kolz,GtkWidget *wpredok)
{
time_t		tmm;
struct  tm      *bf;
FILE		*ff;
