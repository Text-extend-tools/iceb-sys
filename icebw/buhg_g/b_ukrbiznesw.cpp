/*$Id: b_ukrbiznesw.c,v 1.5 2013/09/26 09:46:46 sasa Exp $*/
/*20.05.2016	15.03.2011	Белых А.И.	b_ukrbiznesw.c
...
while(cur.read_cursor(&row) != 0)
 {
  ...
  /*Читаем комментарий*/
  readkomw(tabl,rec.dd,rec.md,rec.gd,rec.nomdk.ravno(),&koment,wpredok); /*иначе отбрасывает копейку*/

  int suma_int=iceb_u_okrug(rec.sumd*100.,0.1);
