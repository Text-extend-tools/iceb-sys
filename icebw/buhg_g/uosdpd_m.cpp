/*$Id: uosdpd_m.c,v 1.15 2013/09/26 09:46:56 sasa Exp $*/
...
g_signal_connect_after(data.window,"key_press_event",G_CALLBACK(uosdpd_v_key_press),&data);
...
g_signal_connect(data.knopka_enter[E_DATAN],"clicked",G_CALLBACK(uosdpd_v_e_knopka),&data);
...
g_signal_connect(data.entry[E_DATAN], "activate",G_CALLBACK(uosdpd_v_vvod),&data);
...
g_signal_connect(data.knopka_enter[E_DATAK],"clicked",G_CALLBACK(uosdpd_v_e_knopka),&data);
...
g_signal_connect(data.entry[E_DATAK], "activate",G_CALLBACK(uosdpd_v_vvod),&data);
...
g_signal_connect(data.knopka_enter[E_KONTR],"clicked",G_CALLBACK(uosdpd_v_e_knopka),&data);
...
g_signal_connect(data.entry[E_KONTR], "activate",G_CALLBACK(uosdpd_v_vvod),&data);
...
g_signal_connect(data.knopka_enter[E_PODR],"clicked",G_CALLBACK(uosdpd_v_e_knopka),&data);
...
g_signal_connect(data.entry[E_PODR], "activate",G_CALLBACK(uosdpd_v_vvod),&data);
...
g_signal_connect(data.knopka_enter[E_SHETU],"clicked",G_CALLBACK(uosdpd_v_e_knopka),&data);
...
g_signal_connect(data.entry[E_SHETU], "activate",G_CALLBACK(uosdpd_v_vvod),&data);
...
g_signal_connect(data.knopka_enter[E_KOD_OP],"clicked",G_CALLBACK(uosdpd_v_e_knopka),&data);
...
g_signal_connect(data.entry[E_KOD_OP], "activate",G_CALLBACK(uosdpd_v_vvod),&data);
...
g_signal_connect(data.knopka_enter[E_MAT_OT],"clicked",G_CALLBACK(uosdpd_v_e_knopka),&data);
...
g_signal_connect(data.entry[E_MAT_OT], "activate",G_CALLBACK(uosdpd_v_vvod),&data);
...
g_signal_connect(data.knopka_enter[E_GRUP_NU],"clicked",G_CALLBACK(uosdpd_v_e_knopka),&data);
gtk_widget_set_name(data.knopka_enter[E_GRUP_NU],iceb_u_inttochar(E_GRUP_NU));
gtk_widget_set_tooltip_text(data.knopka_enter[E_GRUP_NU],gettext("Выбор группы"));

data.entry[E_GRUP_NU] = gtk_entry_new();
gtk_box_pack_start (GTK_BOX (hbox[E_GRUP_NU]), data.entry[E_GRUP_NU], TRUE, TRUE,1);
g_signal_connect(data.entry[E_GRUP_NU], "activate",G_CALLBACK(uosdpd_v_vvod),&data);
gtk_entry_set_text(GTK_ENTRY(data.entry[E_GRUP_NU]),data.rk->grup_nu.ravno());
...
g_signal_connect(data.knopka_enter[E_GRUP_BU],"clicked",G_CALLBACK(uosdpd_v_e_knopka),&data);
gtk_widget_set_name(data.knopka_enter[E_GRUP_BU],iceb_u_inttochar(E_GRUP_BU));
gtk_widget_set_tooltip_text(data.knopka_enter[E_GRUP_BU],gettext("Выбор группы"));

data.entry[E_GRUP_BU] = gtk_entry_new();
gtk_box_pack_start (GTK_BOX (hbox[E_GRUP_BU]), data.entry[E_GRUP_BU], TRUE, TRUE,1);
g_signal_connect(data.entry[E_GRUP_BU], "activate",G_CALLBACK(uosdpd_v_vvod),&data);
gtk_entry_set_text(GTK_ENTRY(data.entry[E_GRUP_BU]),data.rk->grup_bu.ravno());
...
g_signal_connect(data.knopka[FK2],"clicked",G_CALLBACK(uosdpd_v_knopka),&data);
...
g_signal_connect(data.knopka[FK4],"clicked",G_CALLBACK(uosdpd_v_knopka),&data);
...
g_signal_connect(data.knopka[FK10],"clicked",G_CALLBACK(uosdpd_v_knopka),&data);
...
switch (enter)
 {
  ...
  case E_MAT_OT:
    ...
    break;
  case E_GRUP_NU:
    data->rk->grup_nu.new_plus(gtk_entry_get_text(GTK_ENTRY(widget)));
    break;

  case E_GRUP_BU:
    data->rk->grup_bu.new_plus(gtk_entry_get_text(GTK_ENTRY(widget)));
    break;
