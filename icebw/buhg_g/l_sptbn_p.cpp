/*$Id: l_sptbn_p.c,v 1.14 2013/08/25 08:26:39 sasa Exp $*/
/*15.09.2006	15.09.2006	Белых А.И.	l_sptbn_p.c
...
gboolean   l_sptbn_p_key_press(GtkWidget *widget,GdkEventKey *event,class l_sptbn_p_data *data);
void    l_sptbn_p_vvod(GtkWidget *widget,class l_sptbn_p_data *data);
void  l_sptbn_p_knopka(GtkWidget *widget,class l_sptbn_p_data *data);
...
g_signal_connect_after(data.window,"key_press_event",G_CALLBACK(l_sptbn_p_key_press),&data);
...
g_signal_connect(data.entry[E_FIO], "activate",G_CALLBACK(l_sptbn_p_vvod),&data);
...
g_signal_connect(data.entry[E_INN], "activate",G_CALLBACK(l_sptbn_p_vvod),&data);
...
g_signal_connect(data.entry[E_METKA_NKS], "activate",G_CALLBACK(l_sptbn_p_vvod),&data);
...
g_signal_connect(data.knopka[FK2],"clicked",G_CALLBACK(l_sptbn_p_knopka),&data);
...
g_signal_connect(data.knopka[FK4],"clicked",G_CALLBACK(l_sptbn_p_knopka),&data);
...
g_signal_connect(data.knopka[FK10],"clicked",G_CALLBACK(l_sptbn_p_knopka),&data);
...
gtk_main();
//printf("l_l_sptbn_p-metka_poi=%d\n",data.rpoi->metka_poi);
...
//g_print("l_sptbn_p_vvod enter=%d\n",enter);
