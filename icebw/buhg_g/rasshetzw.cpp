...
/*30.11.2016	15.09.2000	Белых А.И.	rasshetzw.c
...
void     zarkmdw(int tn,short mp,short gp,int podr,const char *nah_only,GtkWidget*);
...
if(prn == 1 || prn == 3)
 {
  ...
  zarkmdw(tabn,mp,gp,kp,nah_only,wpredok); //Расчёт командировочных
