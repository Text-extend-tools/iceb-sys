...
/*23.05.2016    10.05.2004  Белых А.И.  i_start.c
Стартовая программа для запуска всех подсистем
*/
#define DVERSIQ "23.05.2016"
#include        <pwd.h>
#include        "buhg_g.h"
      ...
      switch(kom)
       {
        ...
        case 1:
          sprintf(strsql,"icebw_xbu -h %s -b %s",host,imabaz);
          if(system(strsql) != 0)
           {
        ...
        case 2:
          sprintf(strsql,"icebw_xmu -h %s -b %s",host,imabaz);
          if(system(strsql) != 0)
           {
            sprintf(bros,"%s-%s",gettext("Не выполнена команда"),strsql);
            iceb_menu_soob(bros,NULL);        
        ...
        case 3:
          sprintf(strsql,"icebw_xdk -h %s -b %s",host,imabaz);
          if(system(strsql) != 0)
           {
            sprintf(bros,"%s-%s",gettext("Не выполнена команда"),strsql);
            iceb_menu_soob(bros,NULL);        
        ...
        case 4:
          sprintf(strsql,"icebw_xzp -h %s -b %s",host,imabaz);
          if(system(strsql) != 0)
           {
            sprintf(bros,"%s-%s",gettext("Не выполнена команда"),strsql);
            iceb_menu_soob(bros,NULL);        
        ...
        case 5:
          sprintf(strsql,"icebw_xuos -h %s -b %s",host,imabaz);
          if(system(strsql) != 0)
           {
            sprintf(bros,"%s-%s",gettext("Не выполнена команда"),strsql);
            iceb_menu_soob(bros,NULL);        
        ...
        case 6:
          sprintf(strsql,"icebw_xusl -h %s -b %s",host,imabaz);
          if(system(strsql) != 0)
           {
            sprintf(bros,"%s-%s",gettext("Не выполнена команда"),strsql);
            iceb_menu_soob(bros,NULL);        
        ...
        case 7:
          sprintf(strsql,"icebw_xkas -h %s -b %s",host,imabaz);
          if(system(strsql) != 0)
           {
            sprintf(bros,"%s-%s",gettext("Не выполнена команда"),strsql);
            iceb_menu_soob(bros,NULL);        
        ...
        case 8:
          sprintf(strsql,"icebw_xukr -h %s -b %s",host,imabaz);
          if(system(strsql) != 0)
           {
            sprintf(bros,"%s-%s",gettext("Не выполнена команда"),strsql);
            iceb_menu_soob(bros,NULL);        
        ...
        case 9:
          sprintf(strsql,"icebw_xupl -h %s -b %s",host,imabaz);
          if(system(strsql) != 0)
           {
            sprintf(bros,"%s-%s",gettext("Не выполнена команда"),strsql);
            iceb_menu_soob(bros,NULL);        
        ...
        case 10:
          sprintf(strsql,"icebw_xrnn -h %s -b %s",host,imabaz);
          if(system(strsql) != 0)
           {
            sprintf(bros,"%s-%s",gettext("Не выполнена команда"),strsql);
            iceb_menu_soob(bros,NULL);        
        ...
        case 11:
          sprintf(strsql,"icebw_xud -h %s -b %s",host,imabaz);
          if(system(strsql) != 0)
           {
            sprintf(bros,"%s-%s",gettext("Не выполнена команда"),strsql);
            iceb_menu_soob(bros,NULL);        
