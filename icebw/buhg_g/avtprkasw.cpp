...
/*10.03.2016	05.10.2000	Белых А.И.	avtprkasw.c
...
class iceb_lock_tables kkkk("LOCK TABLES Prov WRITE,Kasord READ,Kasord1 READ,Blok READ,icebuser READ,Glkkv READ,Alx READ,Plansh READ");
...
//sprintf(kom_new,"N%s %s",nomd,osnov.ravno());
