...
/*18.10.2018	12.08.2003 	Белых А.И.	buhg_g.h
*/
...
void zvb_ibank2ua_strw(int *nomer_zap,const char *fio,const char *shet_b,const char *inn,double suma,FILE *ff,FILE *ffr);
...
void zvb_corp2_endw(const char *imaf_dbf,const char *imaf_dbf_tmp,double sumai,int kolzap,FILE *ffr,FILE *ff_dbf_tmp,GtkWidget *wpredok);
