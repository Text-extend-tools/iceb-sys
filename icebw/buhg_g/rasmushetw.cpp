...
/*02.07.2018    15.04.1997      Белых А.И.      rasmushetw.c
...
int rasmushetw(short dg,short mg,short gg, //дата документа
int skl,  //Склад
...
fprintf(f1,"%-*.*s N%s %-*.*s\n",
iceb_u_kolbait(60,nmo.ravno()),iceb_u_kolbait(60,nmo.ravno()),nmo.ravno(),
kpos.ravno(),
iceb_u_kolbait(60,nmo1.ravno()),iceb_u_kolbait(60,nmo1.ravno()),nmo1.ravno());
...
if(metka_open_fil == 1)
 {
  ...
  iceb_rnl(imaf,&rh,&rasmushet_sap,wpredok);
 } 
return(0);
}
